  ...
  <div class="card">
        ...
        <div class="card-header border-0 pt-6">
          <ul class="nav nav-pills mb-2">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="/custom-payments/vessel">Vessel</a>
            </li>
            <li class="nav-item">
    ...
    <div class="card-body">
            ...
            <tbody class="fw-semibold text-gray-600">
              @foreach ($payments as $vessel => $payment)
                <tr>
                  <td>{{ $payment[0]->inventory->vessel->name }}</td>
