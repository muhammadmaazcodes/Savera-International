            ...
            @method('PUT')
                ...
                <div class="row mb-5">
                    ...
                    <div class="col-md-8">
                      ...
                      <input type="text" name="hawala_party_name" id="hawala_party_name" value="{{ $custom_payment->hawala_party_name }}" class="form-control form-control-sm border border-dark">
                    </div>
                </div>
                <hr>
