<x-default-layout>
  ...
  <div class="d-flex align-items-center gap-2 gap-lg-3">
    ...
    <div class="m-0">
       <!--begin::Menu toggle-->
       <a href="/businesses" class="btn btn-sm btn-flex btn-secondary fw-bold">               
       View All Businesses
       </a>
       <!--end::Menu toggle-->        
    </div>
...
<div class="card card-flush h-md-100 mb-4">
	...
	<div class="card-body pt-6">
		<form class="pt-1" method="POST" action="/businesses/{{ $business->id }}">
			@csrf
			@method('PUT')
			<div class="row">
				<div class="col-md-4">
					@if ($inventories->count() > 0 || $local_contracts->count() > 0)
					<input type="text" class="form-control form-control-lg border-secondary" placeholder="Company Name" name="name" value="{{ $business->name }}" readonly />
					@else
				...
				<div class="col-md-4">
					@if ($inventories->count() > 0 || $local_contracts->count() > 0)
					<input type="text" class="form-control form-control-lg border-secondary" placeholder="Company Code" name="code" value="{{ $business->code }}" readonly />
					@else
				...
				<div class="col-md-4">
					<div class="form-check form-switch mb-3">
						<input class="form-check-input" name="local" type="checkbox" value="1" id="business_local" {{ ($business->local) == 1  ? 'checked' : ''}}>
						<label class="form-check-label text-dark" for="business_local">Local</label>
					</div>
					<div class="form-check form-switch">
						<input class="form-check-input" name="international" value="1" type="checkbox" id="business_intl" {{ ($business->international) == 1  ? 'checked' : ''}}>
			...
			<div id="kt_docs_repeater_basic">
			    ...
			    <div class="form-group">
			        <div class="my-5" data-repeater-list="business_addresses">
...
<div class="card card-flush h-md-100">
	<div class="card-header pt-7">
		...
		<h3 class="card-title align-items-start flex-column">
			<span class="card-label fw-bold text-gray-800">{{ $business->name }} Addresses</span>
			<!--begin::Search-->
																...
																<td class="text-center">
																		...
																		<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
																				...
																				<div class="menu-item px-3">
																					{!! Form::open(['method' => 'DELETE','route' => ['business.address.delete', $address->id],'id' => 'form-delete'.'-'.$address->id ,'style'=>'display:inline']) !!}
		...
		<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="pt-1" method="POST" action="{{ route('business.address.update', $address->id) }}" id="update-bussiness-{{ $address->id }}">
						@csrf
						@method('PUT')
								<!--begin::Form group-->
								<div class="form-group">
				...
				<div class="modal-footer">
					...
					<button type="button" onclick="$('#update-bussiness-{{ $address->id }}').submit();" id="submit-add-btn" class="btn btn-primary">Update</button>
				</div>
