			...
			<div class="accordion" id="accordionExample">
					<div class="accordion-item">
						<h2 class="accordion-header" id="headingOne">
							<button class="accordion-button bg-secondary fw-bold text-dark fs-3" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
								Filter Businesses
							</button> 
						</h2>
						<div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
							<div class="accordion-body">
									<div class="row">
											...
											<div class="col-md-3 mb-2">
													<select id="short_code" class="form-control">
															<option disabled selected>Search Code</option>
															<option value="">All</option>
															@foreach ($businesses as $business)
																	<option value="{{ $business->code }}">{{ $business->code }}</option>
															@endforeach
													</select>
											</div>
											<div class="col-md-3 mb-2">
													<select id="local" class="form-control">
															<option disabled selected>Local Type</option>
															<option value="">All</option>
															<option value="&#10004;">&#10004;</option>
															<option value="&#10006;">&#10006;</option>
													</select>
											...
											<div class="col-md-3 mb-2">
												<select id="international" class="form-control">
													<option disabled selected>Intenrational Type</option>
													<option value="">All</option>
													<option value="&#10004;">&#10004;</option>
													<option value="&#10006;">&#10006;</option>
												</select>
										...
										<div class="card-toolbar">
											<!--begin::Export dropdown-->
												...
												<div class="d-flex justify-content-end"
														...
														<!--begin::Add customer-->
														<button type="button" class="btn btn-primary ms-2" data-bs-toggle="modal" data-bs-target="#AddBusiness">
																Add New Business
														</button>
														<!--end::Add customer-->
												</div>
														...
														<tr>
																...
																<td>
																	<div class="form-check form-switch mb-3">
																		<input class="form-check-input" type="checkbox" disabled {{ ($business->local) == 1  ? 'checked' : ''}}>
																	...
																	<span class="d-none">{!! $business->local == 1 ? 'Yes' : 'No' !!}</span>
																</td>
																<td>
																	<div class="form-check form-switch mb-3">
																		<input class="form-check-input" type="checkbox" disabled {{ ($business->international) == 1  ? 'checked' : ''}}>
																		<label class="form-check-label text-dark"></label>
																	</div>
																	...
																	<span class="d-none">{!! $business->international == 1 ? 'Yes' : 'No' !!}</span>
																</td>
																<td class="text-center action-td">
																		...
																		@else
																				<div class="menu-item px-3">
																					{!! Form::open(['method' => 'DELETE','route' => ['businesses.destroy', $business->id],'id' => 'form-delete'.'-'.$business->id ,'style'=>'display:inline']) !!}
																										{{-- {!! Form::submit('Delete', ['class' => 'menu-link px-3']) !!} --}}
																					{!! Form::close() !!}
																						<a href="javascript:void(0);" onclick="event.preventDefault(); document.getElementById('form-delete-{{ $business->id }}').submit();" class="menu-link px-3"
																								data-kt-customer-table-filter="delete_row">
																								Delete
																						</a>
																				</div>
...
var KTDatatablesExample = function () {
    ...
    // Hook export buttons
    var exportButtons = () => {
        const documentTitle = 'Businesses';
