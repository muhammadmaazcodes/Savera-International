...
<div class="card card-flush h-md-100">
	...
	<div class="card-header pt-7">
		...
		<h3 class="card-title align-items-start flex-column">
			<span class="card-label fw-bold text-gray-800">Add Temporary Contract</span>
		</h3>
		<!--end::Title-->
	</div>
	<!--end::Header-->
				...
				<form class="pt-1" id="contract-form" method="POST" action="/local-contract">
					...
					<div class="row justify-content-center">
						...
						<div class="col-md-4">
							...
							<input type="date" class="form-control form-control-lg border-dark" placeholder="" name="date" required />
						</div>
		
						<div class="col-md-4">
							<label for="voyage_number" class="form-label">Lifting Date</label>
							<input type="date" class="form-control form-control-lg border-dark" placeholder="" name="lifting_date" required />
						</div>

                        <div class="col-md-4">
							<label for="voyage_number" class="form-label">Return Date</label>
							<input type="date" class="form-control form-control-lg border-dark" placeholder="" name="return_date" required />
						</div>    
