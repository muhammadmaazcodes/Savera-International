                  ...
                  <div class="card-header border-0 pt-6">
                      ...
                      <div class="card-title">
                          ...
                          <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                              <a href="{{ url('local-contracts/buyer') }}" class="nav-link tabs-link active">Buyer</a>
                            </li>
                            <li class="nav-item" role="presentation">
                              ...
                              <div class="table-responsive">
                                 ...
                                 <table class="table align-middle table-row-bordered table-hover fs-6 gy-5" id="kt_datatable_example">
                                  ...
                                  <tbody class="fw-semibold text-gray-600">
                                    @foreach ($all_contracts as $buyer_id => $contracts)
                                      @foreach ($contracts as $contract)
                                        @php
                                            $lifted_qty = $contract->map(function($c){
                                            return $c->liftings->sum('quantity');
                                            })->sum();
                                        @endphp                                          
                                        <tr>
                                          <td hidden>
                                          ...
                                          <td>{{ $contract[0]->buyer->name ?? '--' }}</td>
                                          <td>{{ $contract[0]->product->name ?? '--' }}</td>
                                          <td>{{ $contract->sum('quantity') }}</td>
                                          <td>{{ $lifted_qty }}</td>
                                          <td>{{ $contract->sum('quantity') - $lifted_qty }}</td>
