	...
	<div class="d-flex flex-column flex-column-fluid">
		...
		<div id="kt_app_content" class="app-content  flex-column-fluid ">
				...
				<div id="kt_app_content_container" class="app-container  container-xxl ">
										...
										<div class="card-toolbar">
											<!--begin::Export dropdown-->
												...
												<div class="d-flex justify-content-end"
														...
														<!--begin::Add customer-->
														<button type="button" class="btn btn-primary ms-2" data-bs-toggle="modal" data-bs-target="#AddUser">
																Add New User
														</button>
														<!--end::Add customer-->
												</div>
														...
														<tr>
																...
																<td class="text-center">
																		...
																		<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
																				...
																				<div class="menu-item px-3">
																					{!! Form::open(['method' => 'DELETE','route' => ['users.destroy', $user->id],'id' => 'form-delete'.'-'.$user->id ,'style'=>'display:inline']) !!}
																										{{-- {!! Form::submit('Delete', ['class' => 'menu-link px-3']) !!} --}}
																					{!! Form::close() !!}
																						<a href="javascript:void(0);" onclick="event.preventDefault(); document.getElementById('form-delete-{{ $user->id }}').submit();" class="menu-link px-3"
																					...
																					<!--begin::Menu item-->
																					<div class="menu-item px-3">
																						<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#EditUser-{{ $user->id }}"
						...
						<div class="modal fade modal-lg" id="AddUser" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
								<div class="modal-content">
									<div class="modal-header bg-primary pt-5 pb-5">
										<h5 class="modal-title text-white fs-2" id="exampleModalLabel">Add New User</h5>
										<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
									</div>
									<div class="modal-body">
						
										<form class="pt-1" id="add-user-form" method="POST" action="{{ route('users.store') }}">
											@csrf
											<div class="row justify-content-center align-items-center">
												...
												<div class="col-md-5">
													<input type="email" class="form-control form-control-lg mb-4" placeholder="Email" name="email" value="" />
												</div>
												<div class="col-md-5">
									...
									<div class="modal-footer">
										...
										<button type="button" onclick="$('#add-user-form').submit();" id="submit-add-btn" class="btn btn-primary">Submit</button>
									</div>
			...
			@foreach ($data as $key => $user)
								...
								@endphp
						<div class="modal fade modal-lg" id="EditUser-{{ $user->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
								<div class="modal-content">
									<div class="modal-header bg-primary pt-5 pb-5">
										<h5 class="modal-title text-white fs-2" id="exampleModalLabel">Edit User</h5>
										<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
									</div>
									<div class="modal-body">
						
										<form class="pt-1" id="edit-user-form-{{ $user->id }}" method="POST" action="{{ route('users.update', $user->id) }}">
											@csrf
											@method('PUT')
											<div class="row justify-content-center align-items-center">
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-secondary" id="add-close-btn" data-bs-dismiss="modal">Close</button>
										<button type="button" onclick="$('#edit-user-form-{{ $user->id }}').submit();" id="submit-update-btn" class="btn btn-primary">Update</button>
									</div>
