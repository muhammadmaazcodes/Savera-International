...
@endif
	...
	<div class="card-body pt-6">
		<form class="pt-1" method="POST" action="{{ route('users.store') }}">
			@csrf
			<div class="row">
				<div class="col-md-12">
					<div class="row">
						...
						<div class="col-md-8">
							<input type="password" class="form-control form-control-lg mb-4" placeholder="Confirm Password" name="confirm-password" value="{{ old('code') }}" />
						</div>
            <div class="col-md-8">
