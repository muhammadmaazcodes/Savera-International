...
<div id="kt_app_toolbar_container" class="my-5 container-xxl d-flex flex-stack ">
        ...
        <div class="tab-pane pt-5 fade show active" id="landed-cost-olien" role="tabpanel" aria-labelledby="landed-cost-olien-tab">
          ...
          <table class="table table-bordered border-dark w-auto table-responsive fw-bold">
            <tr class="border-0">
              ...
              <td class="border-0"></td>
              <td class="text-center border-top-1">In Dollar</td>
              <td class="text-center border-top-1">In Dollar/MT</td>
              <td class="text-center border-top-1">Share in TOTAL Cost</td>
            </tr>
            <tr class="border-end border-dark">
              <td>USD/Ton</td>
            ...
            <tr class="border-0">
              ...
              <td class="text-end border-top-1"><span id="usd_imp_val_2" class="fw-bold"></span></td>
              <td class="text-end border-top-1"><span id="in_usd_imp_val_2" class="fw-bold"></span></td>
              <td class="text-end border-top-1"><span id="share_usd_imp_val_2" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              ...
              <td class="text-end"><span id="usd_lc_charge" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_lc_charge" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_lc_charge" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              ...
              <td class="text-end"><span id="usd_collector_customs" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_collector_customs" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_collector_customs" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              ...
              <td class="text-end"><span id="usd_coc_pqa" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_coc_pqa" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_coc_pqa" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              ...
              <td class="text-end"><span id="usd_pqa_mt" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_pqa_mt" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_pqa_mt" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              ...
              <td class="text-end"><span id="usd_et_pqa" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_et_pqa" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_et_pqa" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              ...
              <td class="text-end"><span id="usd_per_vessel_charges" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_per_vessel_charges" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_per_vessel_charges" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              ...
              <td class="text-end"><span id="usd_marking" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_marking" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_marking" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              ...
              <td class="text-end"><span id="usd_storage_agent" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_storage_agent" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_storage_agent" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              ...
              <td class="text-end"><span id="usd_insurance_charge" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_insurance_charge" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_insurance_charge" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              <td class="border-bottom-1">LANDED COST BEFORE TAXES</td>
              <td class="text-end"><span id="landed_cost" class="fw-bold"></span></td>
              <td class="text-end"><span id="usd_landed_cost" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_landed_cost" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_landed_cost" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              <td class="border-bottom-1">LESS : INPUT TAX</td>
              <td class="text-end"><span id="less_input_tax" class="fw-bold"></span></td>
              <td class="text-end"><span id="usd_less_input_tax" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_less_input_tax" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_less_input_tax" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              <td class="border-bottom-1">ADD : OUTPUT TAX</td>
              <td class="text-end border-bottom-1"><span id="add_output_tax" class="fw-bold"></span></td>
              <td class="text-end"><span id="usd_add_output_tax" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_add_output_tax" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_add_output_tax" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              <td class="border-bottom-1">SUBTOTAL</td>
              <td class="text-end"><span id="subtotal" class="fw-bold"></span></td>
              <td class="text-end"><span id="usd_subtotal" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_subtotal" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_subtotal" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              <td class="border-bottom-1">ADD : WITHHOLDING TAX 1%</td>
              <td class="text-end"><span id="add_withholding_tax" class="fw-bold"></span></td>
              <td class="text-end"><span id="usd_add_withholding_tax" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_add_withholding_tax" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_add_withholding_tax" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              <td class="border-bottom-1">Miscellaneous Charges</td>
              <td class="text-end"><span id="misc_charges_calc" class="fw-bold"></span></td>
              <td class="text-end"><span id="usd_misc_charges_calc" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_misc_charges_calc" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_misc_charges_calc" class="fw-bold"></span></td>
            </tr>
            <tr class="border-0">
              ...
              <td class="text-end"><span id="usd_handling_charges_calc" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_handling_charges_calc" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_handling_charges_calc" class="fw-bold"></span></td>
            </tr>
            <tr>
              <td>LANDED COST AFTER TAXES</td>
              <td class="text-end"><span id="landed_cost_after_taxes" class="fw-bold"></span></td>
              <td class="text-end"><span id="usd_landed_cost_after_taxes" class="fw-bold"></span></td>
              <td class="text-end"><span id="in_usd_landed_cost_after_taxes" class="fw-bold"></span></td>
              <td class="text-end"><span id="share_usd_landed_cost_after_taxes" class="fw-bold"></span></td>
            </tr>
            ...
            <tr class="border-end border-dark">
              ...
              <td class="text-end"><span id="in_cost_per_ton" class="fw-bold"></span></td>
            </tr>
            ...
            <tr class="border-end border-dark">
              ...
              <td class="text-end"></td>
              <td class="text-end"><span id="in_cost_per_maund" class="fw-bold"></span></td>
            </tr>
  ...
  var usd_imp_val_2 = import_value_2 / exchange_rate;
  $('#usd_imp_val_2').text('$ ' + usd_imp_val_2);

  var in_usd_imp_val_2 = usd_imp_val_2 / exb;
  $('#in_usd_imp_val_2').text('$ ' + in_usd_imp_val_2);
  ...
  var usd_insurance_charge = addCommas(insurance_charge / exchange_rate);
  $('#usd_insurance_charge').text('$ ' + usd_insurance_charge);

  var in_usd_insurance_charge = usd_insurance_charge / exb;
  $('#in_usd_insurance_charge').text('$ ' + in_usd_insurance_charge);
  ...
  var usd_lc_charge = lc_charge / exchange_rate;
  $('#usd_lc_charge').text('$ ' + usd_lc_charge);

  var in_usd_lc_charge = usd_lc_charge / exb;
  $('#in_usd_lc_charge').text('$ ' + in_usd_lc_charge);
  ...
  var usd_storage_agent = addCommas(storage_agent / exchange_rate);
  $('#usd_storage_agent').text('$ ' + usd_storage_agent);

  var in_usd_storage_agent = addCommas((storage_agent / exchange_rate) / exb);
  $('#in_usd_storage_agent').text('$ ' + in_usd_storage_agent);
  ...
  var collector_customs = Math.round(grand_total);
  $('#collector_customs').text(addCommas(collector_customs));
  
  var usd_collector_customs = addCommas(collector_customs / exchange_rate);
  $('#usd_collector_customs').text('$ ' + usd_collector_customs);

  var in_usd_collector_customs = addCommas((collector_customs / exchange_rate) / exb);
  $('#in_usd_collector_customs').text('$ ' + in_usd_collector_customs);
  ...
  var usd_coc_pqa = addCommas(coc_pqa / exchange_rate);
  $('#usd_coc_pqa').text('$ ' + usd_coc_pqa);

  var in_usd_coc_pqa = usd_coc_pqa / exb;
  $('#in_usd_coc_pqa').text('$ ' + in_usd_coc_pqa);
  ...
  var usd_pqa_mt = addCommas(pqa_mt / exchange_rate);
  $('#usd_pqa_mt').text('$ ' + usd_pqa_mt);

  var in_usd_pqa_mt = usd_pqa_mt / exb;
  $('#in_usd_pqa_mt').text('$ ' + in_usd_pqa_mt);
  ...
  var usd_et_pqa = addCommas(et_pqa / exchange_rate);
  $('#usd_et_pqa').text('$ ' + usd_et_pqa);

  var in_usd_et_pqa = usd_et_pqa / exb;
  $('#in_usd_et_pqa').text('$ ' + in_usd_et_pqa);
  ...
  var usd_per_vessel_charges = addCommas(per_vessel_charges / exchange_rate);
  $('#usd_per_vessel_charges').text('$ ' + usd_per_vessel_charges);

  var in_usd_per_vessel_charges = addCommas((per_vessel_charges / exchange_rate) / exb);
  $('#in_usd_per_vessel_charges').text('$ ' + in_usd_per_vessel_charges);
  ...
  var usd_marking = addCommas(Math.round(marking) / exchange_rate);
  $('#usd_marking').text('$ ' + usd_marking);

  var in_usd_marking = usd_marking / exb;
  $('#in_usd_marking').text('$ ' + in_usd_marking);
  ...
  var usd_landed_cost = addCommas(Math.round(landed_cost) / exchange_rate);
  $('#usd_landed_cost').text('$ ' + usd_landed_cost);

  var in_usd_landed_cost = addCommas((Math.round(landed_cost) / exchange_rate) / exb);
  $('#in_usd_landed_cost').text('$ ' + in_usd_landed_cost);

  var less_input_tax = sale_tax_charge;
  $('#less_input_tax').text(addCommas(Math.round(less_input_tax)));

  var usd_less_input_tax = addCommas(Math.round(less_input_tax) / exchange_rate);
  $('#usd_less_input_tax').text('$ ' + usd_less_input_tax);

  var in_usd_less_input_tax = addCommas((Math.round(less_input_tax) / exchange_rate) / exb);
  $('#in_usd_less_input_tax').text('$ ' + in_usd_less_input_tax);

  var add_output_tax = landed_cost * 0.18;
  $('#add_output_tax').text(addCommas(Math.round(add_output_tax)));

  var usd_add_output_tax = addCommas(Math.round(add_output_tax) / exchange_rate);
  $('#usd_add_output_tax').text('$ ' + usd_add_output_tax);

  var in_usd_add_output_tax = addCommas((Math.round(add_output_tax) / exchange_rate) / exb);
  $('#in_usd_add_output_tax').text('$ ' + in_usd_add_output_tax);

  var subtotal = landed_cost - less_input_tax + add_output_tax;
  $('#subtotal').text(addCommas(Math.round(subtotal)));

  var usd_subtotal = addCommas(Math.round(subtotal) / exchange_rate);
  $('#usd_subtotal').text('$ ' + usd_subtotal);

  var in_usd_subtotal = addCommas((Math.round(subtotal) / exchange_rate) / exb);
  $('#in_usd_subtotal').text('$ ' + in_usd_subtotal);
  ...
  var usd_handling_charges_calc = addCommas(Math.round(handling_charges_calc) / exchange_rate);
  $('#usd_handling_charges_calc').text('$ ' + usd_handling_charges_calc);

  var in_usd_handling_charges_calc = usd_handling_charges_calc / exb;
  $('#in_usd_handling_charges_calc').text('$ ' + in_usd_handling_charges_calc);
  ...
  var usd_misc_charges_calc = addCommas(Math.round(misc_charges_calc) / exchange_rate);
  $('#usd_misc_charges_calc').text('$ ' + usd_misc_charges_calc);
  
  var in_usd_misc_charges_calc = usd_misc_charges_calc / exb;
  $('#in_usd_misc_charges_calc').text('$ ' + in_usd_misc_charges_calc);
  ...
  var usd_add_withholding_tax = addCommas(Math.round(add_withholding_tax) / exchange_rate);
  $('#usd_add_withholding_tax').text('$ ' + usd_add_withholding_tax);

  var in_usd_add_withholding_tax = usd_add_withholding_tax / exb;
  $('#in_usd_add_withholding_tax').text('$ ' + in_usd_add_withholding_tax);
  ...
  var usd_landed_cost_after_taxes = addCommas(Math.round(landed_cost_after_taxes) / exchange_rate);
  $('#usd_landed_cost_after_taxes').text('$ ' + usd_landed_cost_after_taxes);

  var in_usd_landed_cost_after_taxes = addCommas((Math.round(landed_cost_after_taxes) / exchange_rate) / exb);
  $('#in_usd_landed_cost_after_taxes').text('$ ' + in_usd_landed_cost_after_taxes);

  var cost_per_ton = landed_cost_after_taxes / landed_qty;
  $('#cost_per_ton').text(addCommas(Math.round(cost_per_ton)));

  var in_cost_per_ton = addCommas(Math.round(cost_per_ton) / exchange_rate);
  $('#in_cost_per_ton').text('$ ' + in_cost_per_ton);

  var cost_per_maund = (cost_per_ton/1000) * 37.324;
  $('#cost_per_maund').text(addCommas(Math.round(cost_per_maund)));

  var in_cost_per_maund = addCommas(Math.round(cost_per_maund) / exchange_rate);
  $('#in_cost_per_maund').text('$ ' + in_cost_per_maund);
  ...
  // Share of Total Cost
  var share_usd_imp_val_2 = (import_value_2 / landed_cost_after_taxes) * 100;
  $('#share_usd_imp_val_2').text(share_usd_imp_val_2.toFixed(2) + '%');

  var share_usd_lc_charge = (lc_charge / landed_cost_after_taxes) * 100;
  $('#share_usd_lc_charge').text(share_usd_lc_charge.toFixed(2) + '%');

  var share_usd_collector_customs = (collector_customs / landed_cost_after_taxes) * 100;
  $('#share_usd_collector_customs').text(share_usd_collector_customs.toFixed(2) + '%');

  var share_usd_coc_pqa = (coc_pqa / landed_cost_after_taxes) * 100;
  $('#share_usd_coc_pqa').text(share_usd_coc_pqa.toFixed(2) + '%');

  var share_usd_pqa_mt = (pqa_mt / landed_cost_after_taxes) * 100;
  $('#share_usd_pqa_mt').text(share_usd_pqa_mt.toFixed(2) + '%');

  var share_usd_et_pqa = (et_pqa / landed_cost_after_taxes) * 100;
  $('#share_usd_et_pqa').text(share_usd_et_pqa.toFixed(2) + '%');

  var share_usd_per_vessel_charges = (per_vessel_charges / landed_cost_after_taxes) * 100;
  $('#share_usd_per_vessel_charges').text(share_usd_per_vessel_charges.toFixed(2) + '%');

  var share_usd_marking = (marking / landed_cost_after_taxes) * 100;
  $('#share_usd_marking').text(share_usd_marking.toFixed(2) + '%');

  var share_usd_storage_agent = (storage_agent / landed_cost_after_taxes) * 100;
  $('#share_usd_storage_agent').text(share_usd_storage_agent.toFixed(2) + '%');

  var share_usd_insurance_charge = (insurance_charge / landed_cost_after_taxes) * 100;
  $('#share_usd_insurance_charge').text(share_usd_insurance_charge.toFixed(2) + '%');

  var share_usd_landed_cost = (landed_cost / landed_cost_after_taxes) * 100;
  $('#share_usd_landed_cost').text(share_usd_landed_cost.toFixed(2) + '%');

  var share_usd_less_input_tax = (less_input_tax / landed_cost_after_taxes) * 100;
  $('#share_usd_less_input_tax').text(share_usd_less_input_tax.toFixed(2) + '%');

  var share_usd_add_output_tax = (add_output_tax / landed_cost_after_taxes) * 100;
  $('#share_usd_add_output_tax').text(share_usd_add_output_tax.toFixed(2) + '%');

  var share_usd_subtotal = (subtotal / landed_cost_after_taxes) * 100;
  $('#share_usd_subtotal').text(share_usd_subtotal.toFixed(2) + '%');
  
  var share_usd_add_withholding_tax = (add_withholding_tax / landed_cost_after_taxes) * 100;
  $('#share_usd_add_withholding_tax').text(share_usd_add_withholding_tax.toFixed(2) + '%');

  var share_usd_misc_charges_calc = (misc_charges_calc / landed_cost_after_taxes) * 100;
  $('#share_usd_misc_charges_calc').text(share_usd_misc_charges_calc.toFixed(2) + '%');

  var share_usd_handling_charges_calc = (handling_charges_calc / landed_cost_after_taxes) * 100;
  $('#share_usd_handling_charges_calc').text(share_usd_handling_charges_calc.toFixed(2) + '%');

  var share_usd_landed_cost_after_taxes = (landed_cost_after_taxes / landed_cost_after_taxes) * 100; 
  $('#share_usd_landed_cost_after_taxes').text(share_usd_landed_cost_after_taxes.toFixed(2) + '%');
