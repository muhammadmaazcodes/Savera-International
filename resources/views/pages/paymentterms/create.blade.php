...
<div class="card card-flush h-md-100">
	...
	<div class="card-header pt-7">
		...
		<h3 class="card-title align-items-start flex-column">
			<span class="card-label fw-bold text-gray-800">Add New Payment Term</span>
		</h3>
		<!--end::Title-->
	</div>
	<!--end::Header-->
	...
	<div class="card-body pt-6">
		<form class="pt-1" method="POST" action="/payment-terms">
			@csrf
			<div class="row">
				<div class="col-md-4">
					<input type="text" class="form-control form-control-sm form-control-solid" placeholder="Payment Term Name" name="name" />
				</div>
				<div class="col-md-2">
