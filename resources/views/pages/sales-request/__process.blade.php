    ...
    <div class="card">
        <div class="card-header pt-7">
            ...
            <h3 class="card-title align-items-start flex-column">
                <span class="card-label fw-bold text-gray-800"><img src="{{ asset('assets/media/icons/sales-view.png') }}" height="40" alt=""> Processing Sales</span>
            </h3>
            <!--end::Title-->
                    ...
                    <tbody>
                        @foreach ($sales as $sale)
                            <tr>
                                ...
                                <td>
                                @isset($sale->inventory)
                                {{ $sale->inventory->vessel->name }}
                                @endisset
                                </td>
                                ...
                                <td>
                                    <div class="d-flex">
                                        ...
                                        @if ($sale->lifting_bls != '[]')
                                            &nbsp; <a href="{{ route('sales.contract',$sale->id) }}" class="btn btn-primary btn-sm">Add Contract</a>
                                        @endif
                                </div>
                                </td>
                            </tr>
