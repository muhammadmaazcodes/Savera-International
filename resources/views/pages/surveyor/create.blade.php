...
<div class="card card-flush h-md-100">
	...
	<div class="card-header pt-7">
		...
		<h3 class="card-title align-items-start flex-column">
			<span class="card-label fw-bold text-gray-800">Add New Surveyor</span>
		</h3>
		<!--end::Title-->
	</div>
	<!--end::Header-->
	...
	<div class="card-body pt-6">
		<form class="pt-1" method="POST" action="/surveyor">
			@csrf
			<div class="row">
				<div class="col-md-9">
					<div class="row">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<input type="text" class="form-control form-control-lg mb-4" placeholder="Phone" name="phone" value="{{ old('phone') }}" />
						</div>
						<div class="col-md-6">
