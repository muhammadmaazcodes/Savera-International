<x-default-layout>
	...
	<div class="d-flex flex-column flex-column-fluid">
		...
		<div id="kt_app_content" class="app-content  flex-column-fluid ">
														...
														<tr>
																...
																<td class="text-center">
																		...
																		<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
																				...
																				<div class="menu-item px-3">
																					{!! Form::open(['method' => 'DELETE','route' => ['payment-types.destroy', $payment_type->id],'id' => 'form-delete'.'-'.$payment_type->id ,'style'=>'display:inline']) !!}
																										{{-- {!! Form::submit('Delete', ['class' => 'menu-link px-3']) !!} --}}
																					{!! Form::close() !!}
																						<a href="javascript:void(0);" onclick="event.preventDefault(); document.getElementById('form-delete-{{ $payment_type->id }}').submit();" class="menu-link px-3"
																					...
																					<!--begin::Menu item-->
																					<div class="menu-item px-3">
																						<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#EditPaymentType-{{ $payment_type->id }}"
							...
							<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
								<div class="modal-content">
									<div class="modal-header bg-primary pt-5 pb-5">
										<h5 class="modal-title text-white fs-2" id="exampleModalLabel">Add New Payment Types</h5>
										<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
									</div>
									<div class="modal-body">
						
										<form class="pt-1" id="add-payment-type-form" method="POST" action="/payment-types">
											@csrf
											<div class="row justify-content-center align-items-center">
												
												<div class="col-md-6">
													<label class="form-label" for="">Payment Type Name<span class="text-danger">*</span></label>
									...
									<div class="modal-footer">
										...
										<button type="button" onclick="$('#add-payment-type-form').submit();" id="submit-add-btn" class="btn btn-primary">Submit</button>
									</div>
			...
			{{-- EDIT Products START --}}
			@foreach ($payment_types as $payment_type)
						<div class="modal fade modal-lg" id="EditPaymentType-{{ $payment_type->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
								<div class="modal-content">
									<div class="modal-header bg-primary pt-5 pb-5">
										<h5 class="modal-title text-white fs-2" id="exampleModalLabel">Edit Payment Type</h5>
										<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
									</div>
									<div class="modal-body">
						
										<form class="pt-1" id="edit-payment-type-form-{{ $payment_type->id }}" method="POST" action="/payment-types/{{ $payment_type->id }}">
											@csrf
											@method('PUT')
											<div class="row justify-content-center align-items-center">
												...
												<div class="col-md-6">
													<label class="form-label" for="">Payment Type Name<span class="text-danger">*</span></label>
													<input type="text" class="form-control form-control-lg border-dark" placeholder="" name="name" value="{{ $payment_type->name }}" required />
												</div>
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-secondary" id="add-close-btn" data-bs-dismiss="modal">Close</button>
										<button type="button" onclick="$('#edit-payment-type-form-{{ $payment_type->id }}').submit();" id="submit-update-btn" class="btn btn-primary">Update</button>
									</div>
...
var KTDatatablesExample = function () {
    ...
    // Hook export buttons
    var exportButtons = () => {
        const documentTitle = 'Payment Types';
