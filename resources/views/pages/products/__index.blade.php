...
<div class="card card-flush h-md-100">
	...
	<div class="card-header pt-7">
		...
		<div class="card-toolbar">
			<a href="/products/create" class="btn btn-sm btn-secondary">Add New</a>
		</div>
		<!--end::Toolbar-->
	</div>
	<!--end::Header-->
			        ...
			        <tr>
			            ...
			            <td>
										...
										@else
											...
											{!! Form::close() !!}
											<a href="/products/{{ $product->id }}/edit" class="btn btn-sm btn-primary align-self-center">Edit</a>
										@endif
									</td>
			        </tr>
			      @endforeach
...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
		...
		<script>
			$(document).on("click",".has-inv", function () {
				swal("This Product contain Inventory !");
			});
