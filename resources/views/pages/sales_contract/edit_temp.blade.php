...
<div class="card card-flush h-md-100">
	...
	<div class="card-header pt-7">
		...
		<h3 class="card-title align-items-start flex-column">
			<span class="card-label fw-bold text-gray-800">Edit Temporary Contract</span>
		</h3>
		<!--end::Title-->
	</div>
	<!--end::Header-->
          ...
          @method('PUT')
					<div class="row justify-content-center">
						...
						<div class="col-md-4">
							...
							<input type="date" class="form-control form-control-lg border-dark" value="{{ $contract->date }}" placeholder="" name="date" required />
						</div>
