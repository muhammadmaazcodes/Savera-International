	...
	<div class="d-flex flex-column flex-column-fluid">
		...
		<div id="kt_app_content" class="app-content  flex-column-fluid ">
				...
				<div id="kt_app_content_container" class="app-container  container-xxl ">
										...
										<div class="card-toolbar">
											<!--begin::Export dropdown-->
												...
												<div class="d-flex justify-content-end"
														...
														<!--begin::Add customer-->
														<button type="button" class="btn btn-primary ms-2" data-bs-toggle="modal" data-bs-target="#AddTransaction">
														...
														<tr>
																...
																<td class="text-center action-td">
																		...
																		<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
																				...
																				<div class="menu-item px-3">
																					{!! Form::open(['method' => 'DELETE','route' => ['transaction-type.destroy', $transaction_type->id],'id' => 'form-delete'.'-'.$transaction_type->id ,'style'=>'display:inline']) !!}
																										{{-- {!! Form::submit('Delete', ['class' => 'menu-link px-3']) !!} --}}
																					{!! Form::close() !!}
																						<a href="javascript:void(0);" onclick="event.preventDefault(); document.getElementById('form-delete-{{ $transaction_type->id }}').submit();" class="menu-link px-3"
																					...
																					<!--begin::Menu item-->
																					<div class="menu-item px-3">
																						<a href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#EditTransaction-{{ $transaction_type->id }}"
						...
						<div class="modal fade modal-lg" id="AddTransaction" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
								<div class="modal-content">
									<div class="modal-header bg-primary pt-5 pb-5">
										<h5 class="modal-title text-white fs-2" id="exampleModalLabel">Add New Transaction Type</h5>
										<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
									</div>
									<div class="modal-body">
						
										<form class="pt-1" id="add-transaction-form" method="POST" action="/transaction-type">
											@csrf
											<div class="row justify-content-center align-items-center">
												<div class="col-md-6">
													<label class="form-label" for="">Transaction Type Name<span class="text-danger">*</span></label>
													<input type="text" class="form-control form-control-lg border-dark" placeholder="" name="name" value="{{ old('name') }}" required />
												</div>
												<div class="col-md-6">
													<label class="form-label" for="">Short Code<span class="text-danger">*</span></label>
									...
									<div class="modal-footer">
										...
										<button type="button" onclick="$('#add-transaction-form').submit();" id="submit-add-btn" class="btn btn-primary">Submit</button>
									</div>
			...
			{{-- EDIT TRANSACTION TYPE START --}}
			@foreach ($transaction_types as $transaction_type)
						<div class="modal fade modal-lg" id="EditTransaction-{{ $transaction_type->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
								<div class="modal-content">
									<div class="modal-header bg-primary pt-5 pb-5">
										<h5 class="modal-title text-white fs-2" id="exampleModalLabel">Edit Transaction Type</h5>
										<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
									</div>
									<div class="modal-body">
						
										<form class="pt-1" id="edit-transaction-form-{{ $transaction_type->id }}" method="POST" action="/transaction-type/{{ $transaction_type->id }}">
											@csrf
											@method('PUT')
											<div class="row justify-content-center align-items-center">
												<div class="col-md-6">
													<label class="form-label" for="">Transaction Type Name<span class="text-danger">*</span></label>
													<input type="text" class="form-control form-control-lg border-dark" placeholder="" name="name" value="{{ $transaction_type->name }}" required />
												</div>
												<div class="col-md-6">
													<label class="form-label" for="">Short Code<span class="text-danger">*</span></label>
													<input type="text" class="form-control form-control-lg border-dark" placeholder="" name="code" value="{{ $transaction_type->code }}" required />
												</div>
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-secondary" id="add-close-btn" data-bs-dismiss="modal">Close</button>
										<button type="button" onclick="$('#edit-transaction-form-{{ $transaction_type->id }}').submit();" id="submit-update-btn" class="btn btn-primary">Update</button>
									</div>
...
var KTDatatablesExample = function () {
    ...
    // Hook export buttons
    var exportButtons = () => {
        const documentTitle = 'Transaction Type';
